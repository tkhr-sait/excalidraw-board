...
- [x] 接続検証レポート（docs/adr/0008-backend-verification.md）
- [x] WebSocketクライアントのサンプル実装（samples/websocket-client/）
- [x] プロトコル仕様書の更新
- [x] 問題点と対策の文書化
...
- [x] WebSocketのエンドポイントURL
- [x] 使用されているSocket.IOのバージョン
- [x] サポートされているイベント一覧
- [x] メッセージのスキーマ定義
- [x] 認証方式（もしあれば）
